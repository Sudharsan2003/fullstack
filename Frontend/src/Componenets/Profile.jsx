...
const Profile = () => {
  ...
  return (
    <div
      style={{
        backgroundImage:
          'url("https://t4.ftcdn.net/jpg/02/10/45/95/240_F_210459536_XmLDEcKq2DpeNLVmheuWeu9NM9aGKnih.jpg")',
        ...
        <div className="listt">
          ...
          >
            <Paper elevation={10} className="paperpp">
              <div className="ava">
                <Avatar
                  src="https://www.nicepng.com/png/detail/52-521023_download-free-icon-male-vectors-blank-facebook-profile.png"
                  sx={{
                    width: 100,
                    height: 100,
                    marginTop: "40px",
